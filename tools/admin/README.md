...
## Daily use
    ...
    admin review               # interactive loop over pending reports
    admin reports list         # list pending reports
    admin reports show <id>    # inspect a specific report
    admin artifact remove <id> --reason "copyright"
    admin pubkey  ban   <hex>  --reason "malware" [--confirm-cascade]
    admin device  ban   <hex>  --reason "abuse"
    admin vocab   add   <tag>
    admin limits  set   --max-bundle-compressed 5242880 [--force]
    admin stats
