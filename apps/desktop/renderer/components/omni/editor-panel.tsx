    ...
    <div className="flex h-full flex-col bg-[#0D0D0F]">
      ...
      <div className="flex h-10 items-center border-b border-[#27272A] bg-[#18181B] overflow-x-auto">
        ...
        >
          ...
          {state.isDirty && !isShowingTab && <span className="w-2 h-2 rounded-full bg-[#F59E0B]" />}
        </button>
        ...
        {state.openTabs.map((tab) => (
          ...
          >
            ...
            {tab.name}
            {tab.isDirty && <span className="w-2 h-2 rounded-full bg-[#F59E0B]" />}
            <span
      ...
      <div className="flex-1 overflow-hidden">
        <Editor
          ...
          options={{
            fontFamily: '"Monaspace Krypton NF", monospace',
            fontSize: 13,
            lineHeight: 20,
