            ...
            {themes.length > 0 ? (
                ...
                {themes.map((theme) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-medium text-[#FAFAFA]">{theme.name}</span>
                      <span className="text-[10px] text-[#52525B] font-mono">{theme.src}</span>
                    </div>
                  </button>
                ))}
              </div>
              ...
              <div className="px-3 py-3 text-center">
                ...
                <p className="text-[10px] text-[#3f3f46] mt-1">
                  Add <span className="font-mono text-[#00D9FF]/60">&lt;theme src="..." /&gt;</span>{' '}
                  in your .omni file
                </p>
              </div>
            )}
          ...
          <div>
            ...
            {widgets.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="text-xs text-[#52525B] mt-1">Add a widget in the editor</p>
              </div>
            ) : (
              <div className="flex flex-col gap-1" role="listbox" aria-label="Widget list">
                {widgets.map((widget) => (
                  <div
                    key={widget.id}
                    role="option"
                      ...
                      <div className="flex flex-col">
                        <span
                          className={cn(
                            ...
                            widget.enabled ? 'text-[#FAFAFA]' : 'text-[#71717A]',
                          )}
                        >
                          {widget.name}
                        </span>
        ...
        <DialogContent className="bg-[#18181B] border-[#27272A]">
          <DialogHeader>
            ...
            <DialogDescription className="text-[#71717A]">
              ...
              <code className="text-[#00D9FF] font-mono text-xs">
                &lt;theme src="themes/name.css" /&gt;
              </code>
            </DialogDescription>
          </DialogHeader>
          <Input
        ...
        <DialogContent className="bg-[#18181B] border-[#27272A]">
          ...
          <div className="flex flex-col gap-1 max-h-[300px] overflow-y-auto">
            {availableThemes.length === 0 ? (
              ...
              availableThemes
                .filter((t) => !themes.some((imported) => imported.src === t))
                .map((themeFile) => (
                  <button
                    key={themeFile}
            ...
            {availableThemes.length > 0 &&
              availableThemes.filter((t) => !themes.some((imported) => imported.src === t))
                .length === 0 && (
                <p className="text-sm text-[#52525B] text-center py-4">
