...
const DATASET: Seed[] = [
  ...
  { id: "a1", authorPub: AUTHOR_A, name: "Alpha",   kind: "theme",  tags: ["dark"],       installs: 10, createdAt: 1000 },
  { id: "a2", authorPub: AUTHOR_A, name: "Bravo",   kind: "bundle", tags: ["dark", "gaming"], installs: 50, createdAt: 1100 },
  { id: "a3", authorPub: AUTHOR_B, name: "Charlie", kind: "theme",  tags: ["light"],      installs: 30, createdAt: 1200 },
  { id: "a4", authorPub: AUTHOR_B, name: "Delta",   kind: "bundle", tags: ["gaming"],     installs: 5,  createdAt: 1300 },
  { id: "a5", authorPub: AUTHOR_A, name: "Echo",    kind: "theme",  tags: ["minimal"],    installs: 50, createdAt: 1400 },
];

interface ListBody {
  items: Array<{ artifact_id: string; name: string; installs: number; tags: string[]; kind: string }>;
  next_cursor?: string;
}
