...
fn props_to_resolved_style(props: &HashMap<String, String>) -> ResolvedStyle {
    ResolvedStyle {
        ...
        padding_top: props.get("padding-top").cloned(),
        padding_right: props.get("padding-right").cloned(),
        padding_bottom: props.get("padding-bottom").cloned(),
        padding_left: props.get("padding-left").cloned(),
        margin: props.get("margin").cloned(),
        margin_top: props.get("margin-top").cloned(),
        margin_right: props.get("margin-right").cloned(),
        margin_bottom: props.get("margin-bottom").cloned(),
        margin_left: props.get("margin-left").cloned(),
